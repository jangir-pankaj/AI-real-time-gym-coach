...
from detectors.squat import SquatDector
...
class VideoProcessorClass(VideoProcessorBase):
    def __init__(self):
        ...
        self._land_marker = vision.PoseLandmarker.create_from_options(options)
    ...
    def _draw_skeleton(self,img,landmarks):
        ...
        for start_index,end_index in POSE_CONNECTIONS:
            p1 = landmarks[start_index]
            p2 = landmarks[end_index]
    ...
    def recv(self, frame):
        ...
        result = self._land_marker.detect_for_video(mp_image,self._frame_timestamps_ms)
